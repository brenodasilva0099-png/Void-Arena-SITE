...
const FEDERATION_REAL_DATA_ID = 'release-2026-07-14-frm-real-data-v1';
const FEDERATION_FINAL_FIXES_ID = 'release-2026-07-14-frm-final-fixes-v1';
let changed = false;
...
const FEDERATION_NO_MOCK_CARD = String.raw`
          <article class="va-card va-update-card" id="release-2026-07-14-frm-no-mock-v1"><span class="va-update-dot"></span><div class="va-update-meta"><span>14/07/2026 • 20:30 BRT</span><span>Site</span><span>No Mock</span></div><h3>Revisão No Mock e resposta de convites por DM</h3><p class="va-muted">Cards falsos e placeholders foram removidos do fluxo principal: o site mostra dados reais ou estado vazio honesto.</p></article>
`;
const FEDERATION_REAL_DATA_CARD = String.raw`
          <article class="va-card va-update-card" id="release-2026-07-14-frm-real-data-v1"><span class="va-update-dot"></span><div class="va-update-meta"><span>14/07/2026 • 20:56 BRT</span><span>Site</span><span>Dados reais</span></div><h3>Jogadores, clubes e Nexus Cup ligados às rotas reais</h3><p class="va-muted">As páginas FRM de atletas, clubes e competições passam a consumir as mesmas fontes reais usadas pela versão antiga.</p></article>
`;
const FEDERATION_FINAL_FIXES_CARD = String.raw`
          <article class="va-card va-update-card" id="release-2026-07-14-frm-final-fixes-v1">
            <span class="va-update-dot"></span>
            <div class="va-update-meta"><span>14/07/2026 • 21:37 BRT</span><span>Site</span><span>Final fixes</span></div>
            <h3>Afiliação, calendário, rankings, perfis e prancheta ajustados</h3>
            <p class="va-muted">Solicitar Afiliação virou cadastro real de clube, o calendário marca a Nexus Cup no dia 18 e rankings/perfis/prancheta receberam ajustes funcionais.</p>
            <ul class="va-update-list">
              <li class="site">Calendário mensal exibe Nexus Cup 1ª Edição em 18/07/2026.</li>
              <li class="site">Afiliação cria clube novo sem abrir a página administrativa de formulários.</li>
              <li class="site">Rankings exibem clubes e atletas registrados com editor administrativo de pontos.</li>
              <li class="site">Perfis públicos de atleta e clube foram criados no visual FRM.</li>
              <li class="fix">Sidebar, rodapé, resultados e links foram reforçados para evitar aparência remendada.</li>
            </ul>
          </article>
`;
...
function patchUpdatesPage() {
  ...
  const before = html;
  if (!html.includes(FEDERATION_FINAL_FIXES_ID)) html = html.replace('<div class="va-timeline">', '<div class="va-timeline">' + FEDERATION_FINAL_FIXES_CARD);
  if (!html.includes(FEDERATION_REAL_DATA_ID)) html = html.replace('<div class="va-timeline">', '<div class="va-timeline">' + FEDERATION_REAL_DATA_CARD);
...
console.log(changed ? '[Atualizacoes] Final fixes FRM registrados.' : '[Atualizacoes] Final fixes FRM ja estavam registrados.');
