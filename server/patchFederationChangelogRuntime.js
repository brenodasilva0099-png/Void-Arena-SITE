...
const FEDERATION_REAL_DATA_CARD = String.raw`
          <article class="va-card va-update-card" id="release-2026-07-14-frm-real-data-v1">
            <span class="va-update-dot"></span>
            <div class="va-update-meta"><span>14/07/2026 • 20:56 BRT</span><span>Site</span><span>Dados reais</span></div>
            <h3>Jogadores, clubes e Nexus Cup ligados às rotas reais</h3>
            <p class="va-muted">As páginas FRM de atletas, clubes e competições passam a consumir as mesmas fontes reais usadas pela versão antiga.</p>
            <ul class="va-update-list">
              <li class="site">Atletas usam o diretório real de jogadores ou o banco real como fallback.</li>
              <li class="site">Clubes afiliados usam /api/teams, preservando elencos e escudos cadastrados.</li>
              <li class="site">Competições usam /api/events para exibir a Nexus Cup 1ª Edição e inscrições reais.</li>
            </ul>
          </article>
`;
...
console.log(changed ? '[Atualizacoes] Dados reais FRM registrados.' : '[Atualizacoes] Dados reais FRM ja estavam registrados.');